...
var wasmImports = {
  b: ___assert_fail,
  Qh: ___syscall__newselect,
  Ph: ___syscall_accept4,
  Oh: ___syscall_bind,
  Nh: ___syscall_connect,
  Mh: ___syscall_dup3,
  i: ___syscall_fcntl64,
  Lh: ___syscall_getpeername,
  Kh: ___syscall_getsockname,
  qa: ___syscall_getsockopt,
  Jh: ___syscall_ioctl,
  Ih: ___syscall_listen,
  Hh: ___syscall_mkdirat,
  pa: ___syscall_openat,
  Gh: ___syscall_poll,
  Fh: ___syscall_readlinkat,
  Eh: ___syscall_recvfrom,
  Dh: ___syscall_renameat,
  Ch: ___syscall_rmdir,
  Bh: ___syscall_sendto,
  Ga: ___syscall_socket,
  Ah: ___syscall_stat64,
  oa: ___syscall_unlinkat,
  xh: __emscripten_get_now_is_monotonic,
  wh: __emscripten_lookup_name,
  vh: __emscripten_system,
  uh: __emscripten_throw_longjmp,
  Ma: __gmtime_js,
  La: __localtime_js,
  Ka: __mktime_js,
  th: __tzset_js,
  N: _abort,
  sh: _dmDeviceJSFreeBufferSlots,
  rh: _dmDeviceJSOpen,
  qh: _dmDeviceJSQueue,
  ph: _dmGetDeviceSampleRate,
  ...
  jh: _dmSysOpenURL,
  ca: _emscripten_asm_const_int,
  ih: _emscripten_cancel_main_loop,
  M: _emscripten_date_now,
  hh: _emscripten_get_heap_max,
  Ea: _emscripten_get_now,
  gh: _emscripten_glActiveTexture,
  fh: _emscripten_glAttachShader,
  eh: _emscripten_glBeginQuery,
  dh: _emscripten_glBeginQueryEXT,
  ch: _emscripten_glBeginTransformFeedback,
  bh: _emscripten_glBindAttribLocation,
  ah: _emscripten_glBindBuffer,
  $g: _emscripten_glBindBufferBase,
  _g: _emscripten_glBindBufferRange,
  Zg: _emscripten_glBindFramebuffer,
  Yg: _emscripten_glBindRenderbuffer,
  Xg: _emscripten_glBindSampler,
  Wg: _emscripten_glBindTexture,
  Vg: _emscripten_glBindTransformFeedback,
  Ug: _emscripten_glBindVertexArray,
  Tg: _emscripten_glBindVertexArrayOES,
  Sg: _emscripten_glBlendColor,
  Rg: _emscripten_glBlendEquation,
  Qg: _emscripten_glBlendEquationSeparate,
  Pg: _emscripten_glBlendFunc,
  Og: _emscripten_glBlendFuncSeparate,
  Ng: _emscripten_glBlitFramebuffer,
  Mg: _emscripten_glBufferData,
  Lg: _emscripten_glBufferSubData,
  Kg: _emscripten_glCheckFramebufferStatus,
  Jg: _emscripten_glClear,
  Ig: _emscripten_glClearBufferfi,
  Hg: _emscripten_glClearBufferfv,
  Gg: _emscripten_glClearBufferiv,
  Fg: _emscripten_glClearBufferuiv,
  Eg: _emscripten_glClearColor,
  Dg: _emscripten_glClearDepthf,
  Cg: _emscripten_glClearStencil,
  Bg: _emscripten_glClientWaitSync,
  Ag: _emscripten_glColorMask,
  zg: _emscripten_glCompileShader,
  yg: _emscripten_glCompressedTexImage2D,
  xg: _emscripten_glCompressedTexImage3D,
  wg: _emscripten_glCompressedTexSubImage2D,
  vg: _emscripten_glCompressedTexSubImage3D,
  ug: _emscripten_glCopyBufferSubData,
  tg: _emscripten_glCopyTexImage2D,
  sg: _emscripten_glCopyTexSubImage2D,
  rg: _emscripten_glCopyTexSubImage3D,
  qg: _emscripten_glCreateProgram,
  pg: _emscripten_glCreateShader,
  og: _emscripten_glCullFace,
  ng: _emscripten_glDeleteBuffers,
  mg: _emscripten_glDeleteFramebuffers,
  lg: _emscripten_glDeleteProgram,
  kg: _emscripten_glDeleteQueries,
  jg: _emscripten_glDeleteQueriesEXT,
  ig: _emscripten_glDeleteRenderbuffers,
  hg: _emscripten_glDeleteSamplers,
  gg: _emscripten_glDeleteShader,
  fg: _emscripten_glDeleteSync,
  eg: _emscripten_glDeleteTextures,
  dg: _emscripten_glDeleteTransformFeedbacks,
  cg: _emscripten_glDeleteVertexArrays,
  bg: _emscripten_glDeleteVertexArraysOES,
  ag: _emscripten_glDepthFunc,
  $f: _emscripten_glDepthMask,
  _f: _emscripten_glDepthRangef,
  ...
  Vf: _emscripten_glDrawArraysInstanced,
  Uf: _emscripten_glDrawArraysInstancedANGLE,
  Tf: _emscripten_glDrawArraysInstancedARB,
  Sf: _emscripten_glDrawArraysInstancedEXT,
  Rf: _emscripten_glDrawArraysInstancedNV,
  Qf: _emscripten_glDrawBuffers,
  Pf: _emscripten_glDrawBuffersEXT,
  Of: _emscripten_glDrawBuffersWEBGL,
  Nf: _emscripten_glDrawElements,
  Mf: _emscripten_glDrawElementsInstanced,
  Lf: _emscripten_glDrawElementsInstancedANGLE,
  Kf: _emscripten_glDrawElementsInstancedARB,
  Jf: _emscripten_glDrawElementsInstancedEXT,
  If: _emscripten_glDrawElementsInstancedNV,
  Hf: _emscripten_glDrawRangeElements,
  Gf: _emscripten_glEnable,
  Ff: _emscripten_glEnableVertexAttribArray,
  Ef: _emscripten_glEndQuery,
  Df: _emscripten_glEndQueryEXT,
  Cf: _emscripten_glEndTransformFeedback,
  Bf: _emscripten_glFenceSync,
  Af: _emscripten_glFinish,
  zf: _emscripten_glFlush,
  yf: _emscripten_glFramebufferRenderbuffer,
  xf: _emscripten_glFramebufferTexture2D,
  wf: _emscripten_glFramebufferTextureLayer,
  vf: _emscripten_glFrontFace,
  uf: _emscripten_glGenBuffers,
  tf: _emscripten_glGenFramebuffers,
  sf: _emscripten_glGenQueries,
  rf: _emscripten_glGenQueriesEXT,
  qf: _emscripten_glGenRenderbuffers,
  pf: _emscripten_glGenSamplers,
  of: _emscripten_glGenTextures,
  nf: _emscripten_glGenTransformFeedbacks,
  mf: _emscripten_glGenVertexArrays,
  lf: _emscripten_glGenVertexArraysOES,
  kf: _emscripten_glGenerateMipmap,
  jf: _emscripten_glGetActiveAttrib,
  hf: _emscripten_glGetActiveUniform,
  gf: _emscripten_glGetActiveUniformBlockName,
  ff: _emscripten_glGetActiveUniformBlockiv,
  ef: _emscripten_glGetActiveUniformsiv,
  df: _emscripten_glGetAttachedShaders,
  cf: _emscripten_glGetAttribLocation,
  bf: _emscripten_glGetBooleanv,
  af: _emscripten_glGetBufferParameteri64v,
  $e: _emscripten_glGetBufferParameteriv,
  _e: _emscripten_glGetError,
  Ze: _emscripten_glGetFloatv,
  Ye: _emscripten_glGetFragDataLocation,
  Xe: _emscripten_glGetFramebufferAttachmentParameteriv,
  We: _emscripten_glGetInteger64i_v,
  Ve: _emscripten_glGetInteger64v,
  Ue: _emscripten_glGetIntegeri_v,
  Te: _emscripten_glGetIntegerv,
  Se: _emscripten_glGetInternalformativ,
  Re: _emscripten_glGetProgramBinary,
  Qe: _emscripten_glGetProgramInfoLog,
  Pe: _emscripten_glGetProgramiv,
  Oe: _emscripten_glGetQueryObjecti64vEXT,
  Ne: _emscripten_glGetQueryObjectivEXT,
  Me: _emscripten_glGetQueryObjectui64vEXT,
  Le: _emscripten_glGetQueryObjectuiv,
  Ke: _emscripten_glGetQueryObjectuivEXT,
  Je: _emscripten_glGetQueryiv,
  Ie: _emscripten_glGetQueryivEXT,
  He: _emscripten_glGetRenderbufferParameteriv,
  Ge: _emscripten_glGetSamplerParameterfv,
  Fe: _emscripten_glGetSamplerParameteriv,
  Ee: _emscripten_glGetShaderInfoLog,
  De: _emscripten_glGetShaderPrecisionFormat,
  Ce: _emscripten_glGetShaderSource,
  Be: _emscripten_glGetShaderiv,
  Ae: _emscripten_glGetString,
  ze: _emscripten_glGetStringi,
  ye: _emscripten_glGetSynciv,
  xe: _emscripten_glGetTexParameterfv,
  we: _emscripten_glGetTexParameteriv,
  ve: _emscripten_glGetTransformFeedbackVarying,
  ue: _emscripten_glGetUniformBlockIndex,
  te: _emscripten_glGetUniformIndices,
  se: _emscripten_glGetUniformLocation,
  re: _emscripten_glGetUniformfv,
  qe: _emscripten_glGetUniformiv,
  pe: _emscripten_glGetUniformuiv,
  oe: _emscripten_glGetVertexAttribIiv,
  ne: _emscripten_glGetVertexAttribIuiv,
  me: _emscripten_glGetVertexAttribPointerv,
  le: _emscripten_glGetVertexAttribfv,
  ke: _emscripten_glGetVertexAttribiv,
  je: _emscripten_glHint,
  ie: _emscripten_glInvalidateFramebuffer,
  he: _emscripten_glInvalidateSubFramebuffer,
  ge: _emscripten_glIsBuffer,
  fe: _emscripten_glIsEnabled,
  ee: _emscripten_glIsFramebuffer,
  de: _emscripten_glIsProgram,
  ce: _emscripten_glIsQuery,
  be: _emscripten_glIsQueryEXT,
  ae: _emscripten_glIsRenderbuffer,
  $d: _emscripten_glIsSampler,
  _d: _emscripten_glIsShader,
  Zd: _emscripten_glIsSync,
  Yd: _emscripten_glIsTexture,
  Xd: _emscripten_glIsTransformFeedback,
  Wd: _emscripten_glIsVertexArray,
  Vd: _emscripten_glIsVertexArrayOES,
  Ud: _emscripten_glLineWidth,
  Td: _emscripten_glLinkProgram,
  Sd: _emscripten_glPauseTransformFeedback,
  Rd: _emscripten_glPixelStorei,
  Qd: _emscripten_glPolygonOffset,
  Pd: _emscripten_glProgramBinary,
  Od: _emscripten_glProgramParameteri,
  Nd: _emscripten_glQueryCounterEXT,
  Md: _emscripten_glReadBuffer,
  Ld: _emscripten_glReadPixels,
  Kd: _emscripten_glReleaseShaderCompiler,
  Jd: _emscripten_glRenderbufferStorage,
  Id: _emscripten_glRenderbufferStorageMultisample,
  Hd: _emscripten_glResumeTransformFeedback,
  Gd: _emscripten_glSampleCoverage,
  Fd: _emscripten_glSamplerParameterf,
  Ed: _emscripten_glSamplerParameterfv,
  Dd: _emscripten_glSamplerParameteri,
  Cd: _emscripten_glSamplerParameteriv,
  Bd: _emscripten_glScissor,
  Ad: _emscripten_glShaderBinary,
  ...
  qd: _emscripten_glTexParameterf,
  pd: _emscripten_glTexParameterfv,
  od: _emscripten_glTexParameteri,
  nd: _emscripten_glTexParameteriv,
  md: _emscripten_glTexStorage2D,
  ld: _emscripten_glTexStorage3D,
  kd: _emscripten_glTexSubImage2D,
  jd: _emscripten_glTexSubImage3D,
  id: _emscripten_glTransformFeedbackVaryings,
  hd: _emscripten_glUniform1f,
  gd: _emscripten_glUniform1fv,
  fd: _emscripten_glUniform1i,
  ed: _emscripten_glUniform1iv,
  dd: _emscripten_glUniform1ui,
  cd: _emscripten_glUniform1uiv,
  bd: _emscripten_glUniform2f,
  ad: _emscripten_glUniform2fv,
  $c: _emscripten_glUniform2i,
  _c: _emscripten_glUniform2iv,
  Zc: _emscripten_glUniform2ui,
  Yc: _emscripten_glUniform2uiv,
  Xc: _emscripten_glUniform3f,
  Wc: _emscripten_glUniform3fv,
  Vc: _emscripten_glUniform3i,
  Uc: _emscripten_glUniform3iv,
  Tc: _emscripten_glUniform3ui,
  Sc: _emscripten_glUniform3uiv,
  Rc: _emscripten_glUniform4f,
  Qc: _emscripten_glUniform4fv,
  Pc: _emscripten_glUniform4i,
  Oc: _emscripten_glUniform4iv,
  Nc: _emscripten_glUniform4ui,
  Mc: _emscripten_glUniform4uiv,
  Lc: _emscripten_glUniformBlockBinding,
  Kc: _emscripten_glUniformMatrix2fv,
  Jc: _emscripten_glUniformMatrix2x3fv,
  Ic: _emscripten_glUniformMatrix2x4fv,
  Hc: _emscripten_glUniformMatrix3fv,
  Gc: _emscripten_glUniformMatrix3x2fv,
  Fc: _emscripten_glUniformMatrix3x4fv,
  Ec: _emscripten_glUniformMatrix4fv,
  Dc: _emscripten_glUniformMatrix4x2fv,
  Cc: _emscripten_glUniformMatrix4x3fv,
  Bc: _emscripten_glUseProgram,
  Ac: _emscripten_glValidateProgram,
  zc: _emscripten_glVertexAttrib1f,
  yc: _emscripten_glVertexAttrib1fv,
  xc: _emscripten_glVertexAttrib2f,
  wc: _emscripten_glVertexAttrib2fv,
  vc: _emscripten_glVertexAttrib3f,
  uc: _emscripten_glVertexAttrib3fv,
  tc: _emscripten_glVertexAttrib4f,
  sc: _emscripten_glVertexAttrib4fv,
  rc: _emscripten_glVertexAttribDivisor,
  qc: _emscripten_glVertexAttribDivisorANGLE,
  pc: _emscripten_glVertexAttribDivisorARB,
  oc: _emscripten_glVertexAttribDivisorEXT,
  nc: _emscripten_glVertexAttribDivisorNV,
  mc: _emscripten_glVertexAttribI4i,
  lc: _emscripten_glVertexAttribI4iv,
  kc: _emscripten_glVertexAttribI4ui,
  jc: _emscripten_glVertexAttribI4uiv,
  ic: _emscripten_glVertexAttribIPointer,
  hc: _emscripten_glVertexAttribPointer,
  gc: _emscripten_glViewport,
  fc: _emscripten_glWaitSync,
  ec: _emscripten_memcpy_js,
  dc: _emscripten_pause_main_loop,
  cc: _emscripten_resize_heap,
  ma: _emscripten_set_main_loop_arg,
  d: _emscripten_webgl_enable_extension,
  bc: _emscripten_webgl_get_current_context,
  zh: _environ_get,
  yh: _environ_sizes_get,
  la: _exit,
  O: _fd_close,
  Fa: _fd_read,
  Na: _fd_seek,
  ...
  t: _glAttachShader,
  f: _glBindBuffer,
  ka: _glBindFramebuffer,
  C: _glBindRenderbuffer,
  h: _glBindTexture,
  ac: _glBlendEquation,
  $b: _glBlendEquationSeparate,
  Da: _glBlendFunc,
  _b: _glBlendFuncSeparate,
  aa: _glBufferData,
  Ca: _glBufferSubData,
  ...
  Ba: _glCompressedTexImage3D,
  r: _glCompressedTexSubImage2D,
  Ub: _glCompressedTexSubImage3D,
  _: _glCreateProgram,
  L: _glCreateShader,
  Tb: _glCullFace,
  Z: _glDeleteBuffers,
  ...
  Mb: _glFlush,
  Lb: _glFramebufferRenderbuffer,
  Kb: _glFramebufferTexture2D,
  Jb: _glFrontFace,
  X: _glGenBuffers,
  Ib: _glGenFramebuffers,
  J: _glGenRenderbuffers,
  W: _glGenTextures,
  Hb: _glGetActiveAttrib,
  Gb: _glGetActiveUniform,
  ...
  Eb: _glPolygonOffset,
  Db: _glReadPixels,
  ga: _glRenderbufferStorage,
  fa: _glScissor,
  x: _glShaderSource,
  Cb: _glStencilFunc,
  Bb: _glStencilFuncSeparate,
  Ab: _glStencilMask,
  zb: _glStencilOp,
  yb: _glStencilOpSeparate,
  l: _glTexImage2D,
  xb: _glTexImage3D,
  wb: _glTexParameterf,
  k: _glTexParameteri,
  ...
  xa: _glUniform1i,
  ub: _glUniform4fv,
  wa: _glUniformMatrix4fv,
  T: _glUseProgram,
  S: _glVertexAttribPointer,
  ea: _glViewport,
  tb: _glfwAccelerometerEnable,
  sb: _glfwCloseWindow,
  rb: _glfwDisable,
  qb: _glfwEnable,
  pb: _glfwGetAcceleration,
  va: _glfwGetDefaultFramebuffer,
  ob: _glfwGetDisplayScaleFactor,
  nb: _glfwGetJoystickButtons,
  mb: _glfwGetJoystickDeviceId,
  lb: _glfwGetJoystickHats,
  R: _glfwGetJoystickParam,
  ...
  ua: _glfwGetWindowSize,
  db: _glfwIconifyWindow,
  cb: _glfwInitJS,
  ta: _glfwOpenWindow,
  G: _glfwOpenWindowHint,
  bb: _glfwPollEvents,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Rh"])();
};
...
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Th"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Uh"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["Vh"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["Xh"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["Yh"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["Zh"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["_h"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["$h"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["ai"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["bi"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["ci"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["di"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["ei"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["fi"])(a0);
};
...
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["hi"])(a0, a1);
};
