...
var wasmImports = {
  b: ___assert_fail,
  Uh: ___syscall__newselect,
  Th: ___syscall_accept4,
  Sh: ___syscall_bind,
  Rh: ___syscall_connect,
  Qh: ___syscall_dup3,
  i: ___syscall_fcntl64,
  Ph: ___syscall_getpeername,
  Oh: ___syscall_getsockname,
  sa: ___syscall_getsockopt,
  Nh: ___syscall_ioctl,
  Mh: ___syscall_listen,
  Lh: ___syscall_mkdirat,
  ra: ___syscall_openat,
  Kh: ___syscall_poll,
  Jh: ___syscall_readlinkat,
  Ih: ___syscall_recvfrom,
  Hh: ___syscall_renameat,
  Gh: ___syscall_rmdir,
  Fh: ___syscall_sendto,
  Ha: ___syscall_socket,
  Eh: ___syscall_stat64,
  qa: ___syscall_unlinkat,
  Bh: __emscripten_get_now_is_monotonic,
  Ah: __emscripten_lookup_name,
  zh: __emscripten_system,
  yh: __emscripten_throw_longjmp,
  Na: __gmtime_js,
  Ma: __localtime_js,
  La: __mktime_js,
  xh: __tzset_js,
  O: _abort,
  wh: _dmDeviceJSFreeBufferSlots,
  vh: _dmDeviceJSOpen,
  uh: _dmDeviceJSQueue,
  th: _dmGetDeviceSampleRate,
  sh: _dmScriptHttpRequestAsync,
  rh: _dmSysGetApplicationPath,
  qh: _dmSysGetUserAgent,
  ph: _dmSysGetUserPersistentDataRoot,
  oh: _dmSysGetUserPreferredLanguage,
  nh: _dmSysOpenURL,
  da: _emscripten_asm_const_int,
  mh: _emscripten_cancel_main_loop,
  N: _emscripten_date_now,
  lh: _emscripten_get_heap_max,
  Fa: _emscripten_get_now,
  kh: _emscripten_glActiveTexture,
  jh: _emscripten_glAttachShader,
  ih: _emscripten_glBeginQuery,
  hh: _emscripten_glBeginQueryEXT,
  gh: _emscripten_glBeginTransformFeedback,
  fh: _emscripten_glBindAttribLocation,
  eh: _emscripten_glBindBuffer,
  dh: _emscripten_glBindBufferBase,
  ch: _emscripten_glBindBufferRange,
  bh: _emscripten_glBindFramebuffer,
  ah: _emscripten_glBindRenderbuffer,
  $g: _emscripten_glBindSampler,
  _g: _emscripten_glBindTexture,
  Zg: _emscripten_glBindTransformFeedback,
  Yg: _emscripten_glBindVertexArray,
  Xg: _emscripten_glBindVertexArrayOES,
  Wg: _emscripten_glBlendColor,
  Vg: _emscripten_glBlendEquation,
  Ug: _emscripten_glBlendEquationSeparate,
  Tg: _emscripten_glBlendFunc,
  Sg: _emscripten_glBlendFuncSeparate,
  Rg: _emscripten_glBlitFramebuffer,
  Qg: _emscripten_glBufferData,
  Pg: _emscripten_glBufferSubData,
  Og: _emscripten_glCheckFramebufferStatus,
  Ng: _emscripten_glClear,
  Mg: _emscripten_glClearBufferfi,
  Lg: _emscripten_glClearBufferfv,
  Kg: _emscripten_glClearBufferiv,
  Jg: _emscripten_glClearBufferuiv,
  Ig: _emscripten_glClearColor,
  Hg: _emscripten_glClearDepthf,
  Gg: _emscripten_glClearStencil,
  ...
  Bg: _emscripten_glCompressedTexImage3D,
  Ag: _emscripten_glCompressedTexSubImage2D,
  zg: _emscripten_glCompressedTexSubImage3D,
  yg: _emscripten_glCopyBufferSubData,
  xg: _emscripten_glCopyTexImage2D,
  wg: _emscripten_glCopyTexSubImage2D,
  vg: _emscripten_glCopyTexSubImage3D,
  ug: _emscripten_glCreateProgram,
  tg: _emscripten_glCreateShader,
  sg: _emscripten_glCullFace,
  rg: _emscripten_glDeleteBuffers,
  qg: _emscripten_glDeleteFramebuffers,
  pg: _emscripten_glDeleteProgram,
  og: _emscripten_glDeleteQueries,
  ng: _emscripten_glDeleteQueriesEXT,
  mg: _emscripten_glDeleteRenderbuffers,
  lg: _emscripten_glDeleteSamplers,
  kg: _emscripten_glDeleteShader,
  jg: _emscripten_glDeleteSync,
  ig: _emscripten_glDeleteTextures,
  hg: _emscripten_glDeleteTransformFeedbacks,
  gg: _emscripten_glDeleteVertexArrays,
  fg: _emscripten_glDeleteVertexArraysOES,
  eg: _emscripten_glDepthFunc,
  dg: _emscripten_glDepthMask,
  cg: _emscripten_glDepthRangef,
  bg: _emscripten_glDetachShader,
  ag: _emscripten_glDisable,
  $f: _emscripten_glDisableVertexAttribArray,
  _f: _emscripten_glDrawArrays,
  Zf: _emscripten_glDrawArraysInstanced,
  Yf: _emscripten_glDrawArraysInstancedANGLE,
  Xf: _emscripten_glDrawArraysInstancedARB,
  Wf: _emscripten_glDrawArraysInstancedEXT,
  Vf: _emscripten_glDrawArraysInstancedNV,
  Uf: _emscripten_glDrawBuffers,
  Tf: _emscripten_glDrawBuffersEXT,
  Sf: _emscripten_glDrawBuffersWEBGL,
  Rf: _emscripten_glDrawElements,
  Qf: _emscripten_glDrawElementsInstanced,
  Pf: _emscripten_glDrawElementsInstancedANGLE,
  Of: _emscripten_glDrawElementsInstancedARB,
  Nf: _emscripten_glDrawElementsInstancedEXT,
  Mf: _emscripten_glDrawElementsInstancedNV,
  Lf: _emscripten_glDrawRangeElements,
  Kf: _emscripten_glEnable,
  Jf: _emscripten_glEnableVertexAttribArray,
  If: _emscripten_glEndQuery,
  Hf: _emscripten_glEndQueryEXT,
  Gf: _emscripten_glEndTransformFeedback,
  Ff: _emscripten_glFenceSync,
  ...
  Af: _emscripten_glFramebufferTextureLayer,
  zf: _emscripten_glFrontFace,
  yf: _emscripten_glGenBuffers,
  xf: _emscripten_glGenFramebuffers,
  wf: _emscripten_glGenQueries,
  vf: _emscripten_glGenQueriesEXT,
  uf: _emscripten_glGenRenderbuffers,
  tf: _emscripten_glGenSamplers,
  sf: _emscripten_glGenTextures,
  rf: _emscripten_glGenTransformFeedbacks,
  qf: _emscripten_glGenVertexArrays,
  pf: _emscripten_glGenVertexArraysOES,
  of: _emscripten_glGenerateMipmap,
  nf: _emscripten_glGetActiveAttrib,
  mf: _emscripten_glGetActiveUniform,
  lf: _emscripten_glGetActiveUniformBlockName,
  kf: _emscripten_glGetActiveUniformBlockiv,
  jf: _emscripten_glGetActiveUniformsiv,
  hf: _emscripten_glGetAttachedShaders,
  gf: _emscripten_glGetAttribLocation,
  ff: _emscripten_glGetBooleanv,
  ef: _emscripten_glGetBufferParameteri64v,
  df: _emscripten_glGetBufferParameteriv,
  cf: _emscripten_glGetError,
  bf: _emscripten_glGetFloatv,
  af: _emscripten_glGetFragDataLocation,
  $e: _emscripten_glGetFramebufferAttachmentParameteriv,
  _e: _emscripten_glGetInteger64i_v,
  Ze: _emscripten_glGetInteger64v,
  Ye: _emscripten_glGetIntegeri_v,
  Xe: _emscripten_glGetIntegerv,
  We: _emscripten_glGetInternalformativ,
  Ve: _emscripten_glGetProgramBinary,
  Ue: _emscripten_glGetProgramInfoLog,
  Te: _emscripten_glGetProgramiv,
  Se: _emscripten_glGetQueryObjecti64vEXT,
  Re: _emscripten_glGetQueryObjectivEXT,
  Qe: _emscripten_glGetQueryObjectui64vEXT,
  Pe: _emscripten_glGetQueryObjectuiv,
  Oe: _emscripten_glGetQueryObjectuivEXT,
  Ne: _emscripten_glGetQueryiv,
  Me: _emscripten_glGetQueryivEXT,
  Le: _emscripten_glGetRenderbufferParameteriv,
  Ke: _emscripten_glGetSamplerParameterfv,
  Je: _emscripten_glGetSamplerParameteriv,
  Ie: _emscripten_glGetShaderInfoLog,
  He: _emscripten_glGetShaderPrecisionFormat,
  Ge: _emscripten_glGetShaderSource,
  Fe: _emscripten_glGetShaderiv,
  Ee: _emscripten_glGetString,
  De: _emscripten_glGetStringi,
  Ce: _emscripten_glGetSynciv,
  Be: _emscripten_glGetTexParameterfv,
  Ae: _emscripten_glGetTexParameteriv,
  ze: _emscripten_glGetTransformFeedbackVarying,
  ye: _emscripten_glGetUniformBlockIndex,
  xe: _emscripten_glGetUniformIndices,
  we: _emscripten_glGetUniformLocation,
  ve: _emscripten_glGetUniformfv,
  ue: _emscripten_glGetUniformiv,
  te: _emscripten_glGetUniformuiv,
  se: _emscripten_glGetVertexAttribIiv,
  re: _emscripten_glGetVertexAttribIuiv,
  qe: _emscripten_glGetVertexAttribPointerv,
  pe: _emscripten_glGetVertexAttribfv,
  oe: _emscripten_glGetVertexAttribiv,
  ne: _emscripten_glHint,
  me: _emscripten_glInvalidateFramebuffer,
  le: _emscripten_glInvalidateSubFramebuffer,
  ke: _emscripten_glIsBuffer,
  je: _emscripten_glIsEnabled,
  ie: _emscripten_glIsFramebuffer,
  he: _emscripten_glIsProgram,
  ge: _emscripten_glIsQuery,
  fe: _emscripten_glIsQueryEXT,
  ee: _emscripten_glIsRenderbuffer,
  de: _emscripten_glIsSampler,
  ce: _emscripten_glIsShader,
  be: _emscripten_glIsSync,
  ae: _emscripten_glIsTexture,
  $d: _emscripten_glIsTransformFeedback,
  _d: _emscripten_glIsVertexArray,
  Zd: _emscripten_glIsVertexArrayOES,
  Yd: _emscripten_glLineWidth,
  Xd: _emscripten_glLinkProgram,
  Wd: _emscripten_glPauseTransformFeedback,
  Vd: _emscripten_glPixelStorei,
  Ud: _emscripten_glPolygonOffset,
  Td: _emscripten_glProgramBinary,
  Sd: _emscripten_glProgramParameteri,
  Rd: _emscripten_glQueryCounterEXT,
  Qd: _emscripten_glReadBuffer,
  Pd: _emscripten_glReadPixels,
  Od: _emscripten_glReleaseShaderCompiler,
  Nd: _emscripten_glRenderbufferStorage,
  Md: _emscripten_glRenderbufferStorageMultisample,
  Ld: _emscripten_glResumeTransformFeedback,
  Kd: _emscripten_glSampleCoverage,
  Jd: _emscripten_glSamplerParameterf,
  Id: _emscripten_glSamplerParameterfv,
  Hd: _emscripten_glSamplerParameteri,
  Gd: _emscripten_glSamplerParameteriv,
  Fd: _emscripten_glScissor,
  Ed: _emscripten_glShaderBinary,
  Dd: _emscripten_glShaderSource,
  Cd: _emscripten_glStencilFunc,
  Bd: _emscripten_glStencilFuncSeparate,
  Ad: _emscripten_glStencilMask,
  zd: _emscripten_glStencilMaskSeparate,
  yd: _emscripten_glStencilOp,
  xd: _emscripten_glStencilOpSeparate,
  wd: _emscripten_glTexImage2D,
  vd: _emscripten_glTexImage3D,
  ud: _emscripten_glTexParameterf,
  td: _emscripten_glTexParameterfv,
  sd: _emscripten_glTexParameteri,
  rd: _emscripten_glTexParameteriv,
  qd: _emscripten_glTexStorage2D,
  pd: _emscripten_glTexStorage3D,
  od: _emscripten_glTexSubImage2D,
  nd: _emscripten_glTexSubImage3D,
  md: _emscripten_glTransformFeedbackVaryings,
  ld: _emscripten_glUniform1f,
  kd: _emscripten_glUniform1fv,
  jd: _emscripten_glUniform1i,
  id: _emscripten_glUniform1iv,
  hd: _emscripten_glUniform1ui,
  gd: _emscripten_glUniform1uiv,
  fd: _emscripten_glUniform2f,
  ed: _emscripten_glUniform2fv,
  dd: _emscripten_glUniform2i,
  cd: _emscripten_glUniform2iv,
  bd: _emscripten_glUniform2ui,
  ad: _emscripten_glUniform2uiv,
  $c: _emscripten_glUniform3f,
  _c: _emscripten_glUniform3fv,
  Zc: _emscripten_glUniform3i,
  Yc: _emscripten_glUniform3iv,
  Xc: _emscripten_glUniform3ui,
  Wc: _emscripten_glUniform3uiv,
  Vc: _emscripten_glUniform4f,
  Uc: _emscripten_glUniform4fv,
  Tc: _emscripten_glUniform4i,
  Sc: _emscripten_glUniform4iv,
  Rc: _emscripten_glUniform4ui,
  Qc: _emscripten_glUniform4uiv,
  Pc: _emscripten_glUniformBlockBinding,
  Oc: _emscripten_glUniformMatrix2fv,
  Nc: _emscripten_glUniformMatrix2x3fv,
  Mc: _emscripten_glUniformMatrix2x4fv,
  Lc: _emscripten_glUniformMatrix3fv,
  ...
  vc: _emscripten_glVertexAttribDivisor,
  uc: _emscripten_glVertexAttribDivisorANGLE,
  tc: _emscripten_glVertexAttribDivisorARB,
  sc: _emscripten_glVertexAttribDivisorEXT,
  rc: _emscripten_glVertexAttribDivisorNV,
  qc: _emscripten_glVertexAttribI4i,
  pc: _emscripten_glVertexAttribI4iv,
  oc: _emscripten_glVertexAttribI4ui,
  ...
  jc: _emscripten_glWaitSync,
  ic: _emscripten_memcpy_js,
  hc: _emscripten_pause_main_loop,
  gc: _emscripten_resize_heap,
  oa: _emscripten_set_main_loop_arg,
  d: _emscripten_webgl_enable_extension,
  fc: _emscripten_webgl_get_current_context,
  Dh: _environ_get,
  Ch: _environ_sizes_get,
  na: _exit,
  P: _fd_close,
  Ga: _fd_read,
  Oa: _fd_seek,
  ...
  D: _glBindRenderbuffer,
  h: _glBindTexture,
  la: _glBindVertexArrayOES,
  ec: _glBlendEquation,
  dc: _glBlendEquationSeparate,
  cc: _glBlendFunc,
  Ea: _glBlendFuncSeparate,
  C: _glBufferData,
  ba: _glBufferSubData,
  aa: _glCheckFramebufferStatus,
  bc: _glClear,
  ac: _glClearColor,
  $b: _glClearDepthf,
  _b: _glClearStencil,
  Zb: _glColorMask,
  B: _glCompileShader,
  s: _glCompressedTexImage2D,
  Da: _glCompressedTexImage3D,
  r: _glCompressedTexSubImage2D,
  Yb: _glCompressedTexSubImage3D,
  $: _glCreateProgram,
  M: _glCreateShader,
  Xb: _glCullFace,
  _: _glDeleteBuffers,
  Wb: _glDeleteFramebuffers,
  A: _glDeleteProgram,
  q: _glDeleteRenderbuffers,
  z: _glDeleteShader,
  L: _glDeleteTextures,
  Vb: _glDeleteVertexArraysOES,
  Ub: _glDepthFunc,
  Tb: _glDepthMask,
  Ca: _glDetachShader,
  m: _glDisable,
  Sb: _glDisableVertexAttribArray,
  Rb: _glDrawArrays,
  Qb: _glDrawBuffers,
  Ba: _glDrawElements,
  o: _glEnable,
  ...
  Pb: _glFlush,
  Ob: _glFramebufferRenderbuffer,
  Nb: _glFramebufferTexture2D,
  Mb: _glFrontFace,
  Y: _glGenBuffers,
  Lb: _glGenFramebuffers,
  K: _glGenRenderbuffers,
  X: _glGenTextures,
  Kb: _glGenVertexArraysOES,
  Jb: _glGetActiveAttrib,
  ...
  fa: _glViewport,
  ub: _glfwAccelerometerEnable,
  tb: _glfwCloseWindow,
  sb: _glfwDisable,
  rb: _glfwEnable,
  qb: _glfwGetAcceleration,
  xa: _glfwGetDefaultFramebuffer,
  pb: _glfwGetDisplayScaleFactor,
  ob: _glfwGetJoystickButtons,
  nb: _glfwGetJoystickDeviceId,
  mb: _glfwGetJoystickHats,
  S: _glfwGetJoystickParam,
  lb: _glfwGetJoystickPos,
  kb: _glfwGetKey,
  j: _glfwGetMouseButton,
  jb: _glfwGetMouseLocked,
  ib: _glfwGetMousePos,
  hb: _glfwGetMouseWheel,
  gb: _glfwGetWindowParam,
  fb: _glfwGetWindowRefreshRate,
  wa: _glfwGetWindowSize,
  eb: _glfwIconifyWindow,
  db: _glfwInitJS,
  va: _glfwOpenWindow,
  H: _glfwOpenWindowHint,
  cb: _glfwPollEvents,
  bb: _glfwResetKeyboard,
  ab: _glfwSetCharCallback,
  $a: _glfwSetDeviceChangedCallback,
  _a: _glfwSetGamepadCallback,
  Za: _glfwSetMarkedTextCallback,
  Ya: _glfwSetTouchCallback,
  Xa: _glfwSetWindowBackgroundColor,
  Wa: _glfwSetWindowCloseCallback,
  Va: _glfwSetWindowFocusCallback,
  Ua: _glfwSetWindowIconifyCallback,
  Ta: _glfwSetWindowSize,
  Sa: _glfwSetWindowSizeCallback,
  Ra: _glfwSetWindowTitle,
  R: _glfwShowKeyboard,
  Qa: _glfwSwapBuffers,
...
var _wasm_call_ctors = function ___wasm_call_ctors() {
  return (_wasm_call_ctors = wasmExports["Vh"])();
};
var _dmExportedSymbols = Module["_dmExportedSymbols"] = function () {
  return (_dmExportedSymbols = Module["_dmExportedSymbols"] = wasmExports["Wh"])();
};
var _main = Module["_main"] = function (a0, a1) {
  return (_main = Module["_main"] = wasmExports["Xh"])(a0, a1);
};
var _malloc = Module["_malloc"] = function (a0) {
  return (_malloc = Module["_malloc"] = wasmExports["Yh"])(a0);
};
var _free = Module["_free"] = function (a0) {
  return (_free = Module["_free"] = wasmExports["Zh"])(a0);
};
var _htonl2 = function _htonl(a0) {
  return (_htonl2 = wasmExports["$h"])(a0);
};
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = function (a0) {
  return (_dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = wasmExports["ai"])(a0);
};
var _dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = function () {
  return (_dmScript_RunInteractionCallback = Module["_dmScript_RunInteractionCallback"] = wasmExports["bi"])();
};
var _setTempRet = function setTempRet0(a0) {
  return (_setTempRet = wasmExports["ci"])(a0);
};
var _htons2 = function _htons(a0) {
  return (_htons2 = wasmExports["di"])(a0);
};
var _ntohs2 = function _ntohs(a0) {
  return (_ntohs2 = wasmExports["ei"])(a0);
};
var _JSWriteDump = Module["_JSWriteDump"] = function (a0) {
  return (_JSWriteDump = Module["_JSWriteDump"] = wasmExports["fi"])(a0);
};
var _setThrew2 = function _setThrew(a0, a1) {
  return (_setThrew2 = wasmExports["gi"])(a0, a1);
};
var _stackSave = function stackSave() {
  return (_stackSave = wasmExports["hi"])();
};
var _stackRestore = function stackRestore(a0) {
  return (_stackRestore = wasmExports["ii"])(a0);
};
var _stackAlloc = function stackAlloc(a0) {
  return (_stackAlloc = wasmExports["ji"])(a0);
};
var dynCall_jii = Module["dynCall_jii"] = function (a0, a1, a2) {
  return (dynCall_jii = Module["dynCall_jii"] = wasmExports["ki"])(a0, a1, a2);
};
var dynCall_ji = Module["dynCall_ji"] = function (a0, a1) {
  return (dynCall_ji = Module["dynCall_ji"] = wasmExports["li"])(a0, a1);
};
